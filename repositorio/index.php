...
//        echo "Lista de Arquivos do diretório '<strong>".$path."</strong>':<br />";
        while($arquivo = $diretorio -> read()){
            ...
            if(strrchr($arquivo, '.')===".java"){
                echo "<div class=\"repitem\"><i class=\"devicon-java-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".c"){
                echo "<div class=\"repitem\"><i class=\"devicon-c-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".cpp"){
                echo "<div class=\"repitem\"><i class=\"devicon-cplusplus-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".js"){
                echo "<div class=\"repitem\"><i class=\"devicon-javascript-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".css"){
                echo "<div class=\"repitem\"><i class=\"devicon-css3-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".html"){
                echo "<div class=\"repitem\"><i class=\"devicon-html5-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".php"){
                echo "<div class=\"repitem\"><i class=\"devicon-php-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".py"){
                echo "<div class=\"repitem\"><i class=\"devicon-python-plain colored\"></i>";
            }
            elseif(strrchr($arquivo, '.')===".apk"){
                echo "<div class=\"repitem\"><i class=\"devicon-android-plain colored\"></i>";
            }
            else{
                echo"<div class=\"repitem\"><i class=\"devicon-google-plain colored\">    </i>";
            }
